                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Chat'e Başla!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Bu Chatbot Opet Çağrıları için Departman Ataması Yapar</h2>
                            </Stack>
                        ) : (
